...
<header class="h-[60px] w-full flex items-center p-[16px] bg-gradient-to-t from-grey-header to-black-header">
    ...
    <li class="flex justify-between gap-[5px]"> 
        <ul class="text-white text-sm">Acceuil</ul>
        <ul class="text-white text-sm">Profil</ul>
        <ul class="text-white text-sm">Connexionn/Inscription</ul>
    </li>
</header>

<body class="w-auto bg-[url('./img/bg_film.jpeg')] bg-cover">

    <div class="w-[324px] h-[408px] bg-black/80 bg-opacity-55 m-auto mt-[140px] p-[16px] z-99">
        <h1 class="text-white text-3xl font-bold mt-[24px] items-start">Connexion</h1>
